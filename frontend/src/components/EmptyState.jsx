...
export default function EmptyState({
  ...
  const renderedIcon = typeof icon === 'string' && SVG_ICONS[icon] ? SVG_ICONS[icon] : (icon || SVG_ICONS.default);

  return (
    <div className={`state-block state-block--empty ${className}`} role="status">
